...
from backend.src.api.services.auth_service import login_user, signup_user
...
def test_signup_user_creates_user_and_saves_to_db(mocker):
    ...
    mock_hash = mocker.patch("backend.src.api.services.auth_service.get_password_hash", return_value="hashed123")
